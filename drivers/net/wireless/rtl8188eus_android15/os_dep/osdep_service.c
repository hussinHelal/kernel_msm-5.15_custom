 ...
 *
 *****************************************************************************/
/*int MODULE_IMPORT_NS(int VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver);
int MODULE_IMPORT_NS(int VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver); */
...
{
	*fpp = NULL;
	return -ENOENT;	/* GKI: filp_open is not in the KMI list */
}
...
{
	return -EPERM;	/* GKI: kernel_read is not in the KMI list */
}
